...
$(function () {
    ...
    window.onbeforeunload = function () {
        ...
        $("#box_industry li.current").length > 2 ? alert("行业领域最多可选2个") : ($("#box_industry li.current").each(function () {
            a.push($(this).text())
        }), "" == a.join() ? $("#select_industry").val("请选择行业领域") : $("#select_industry").val(a.join()), $("#select_industry_hidden").val(a.join()), $("#box_industry").hide()), $("#box_industry").hide(), $("#box_salary").hide(), $("#stagesList .box_invest").hide()
    }), $("#select_industry").bind("click", function (a) {
        a.stopPropagation(), $("#box_industry").show(), $("#box_salary").hide(), $("#stagesList .box_invest").hide()
        ...
        a.stopPropagation(), $("#box_salary").show(), $("#box_industry").hide(), $("#stagesList .box_invest").hide()
    }), $("#box_salary").on("click", "ul li", function (a) {
        a.stopPropagation();
        var b = $(this).text();
        $("#select_salary,#select_salary_hidden").val(b), $("#box_salary").hide(), $("#stepForm").validate().element("#select_scale_hidden")
    }), $("#box_industry,#box_salary").bind("click", function (a) {
        a.stopPropagation()
        ...
        a.stopPropagation(), $("#box_salary").hide(), $("#box_industry").hide(), $(this).parents("li").siblings().children(".box_invest").hide(), $(this).siblings(".box_invest").show()
        ...
        submitHandler: function (b) {
            ...
            a = !0, c = $("#companyId").val(), d = $("#companyName").val(), e = $("#name").val(), f = $("#logoShow img").attr("src"), g = $("#website").val(), "http://" != g.substring(0, 7) && (g = "http://" + g), h = $("#city").val(), i = $("#select_industry_hidden").val(), j = $("#select_salary_hidden").val(), k = $("#s_radio_hidden").val(), l = "", l += "[", $("#stagesList > li").each(function (a) {
